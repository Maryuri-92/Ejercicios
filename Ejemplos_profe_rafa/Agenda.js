...
document.getElementById("btnNuevaCita").addEventListener("click", () => {
    ...
    cajaAsunto.value = "";
    cajaDonde.value = "";
    cajaFecha.value = ""; // fecha: new Date(cajaFecha.value)
...
function hoy() {
    let fechaNueva = document.getElementById("fechaHoy");
    //fechaNueva.innerHTML = (new Date()).toLocaleDateString()
    let dia = new Date()
    fechaNueva.innerHTML = dia.toLocaleDateString()
}
