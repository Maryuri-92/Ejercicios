...
function metodo3() {
    ...
    divResultado.innerHTML = `Extraido ${ultimo}. El array resultante es: ${datos}`;
    //Al imprimir un array, se llama por defecto al metodo toString();
}
...
function metodo16() {
    datos.reverse();
    divResultado.innerHTML = `Datos al reves: ${datos}`;
}
